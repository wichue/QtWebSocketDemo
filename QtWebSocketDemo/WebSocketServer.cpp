    ...
    ui(new Ui::WebSocketServer)
{
    ...
    connect(ui->btnListen,&QPushButton::clicked,this,&WebSocketServer::slotbtnListen);
    //新的连接进来
    connect(server,&QWebSocketServer::newConnection,this,&WebSocketServer::onNewConnection);
    //发送消息给客户端
    connect(ui->btnSend,&QPushButton::clicked,this,&WebSocketServer::slotbtnSend);
}
...
void WebSocketServer::slotbtnListen()
{
...
void WebSocketServer::slotbtnSend()
{
